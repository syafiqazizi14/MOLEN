...
class RekapHonorTahunanSheet implements FromArray, WithHeadings, WithTitle, WithColumnFormatting, ShouldAutoSize, WithEvents
{
    protected $tahun;
    protected $team_id;
    protected $search;
    ...
    {
        return ['No', 'Nama Mitra', 'SOBAT ID', 'Tim', 'Total'];
    }
